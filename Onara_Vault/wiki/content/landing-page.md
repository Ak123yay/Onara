# Landing Page Copy — Onara

_Full copy for onara.tech. Source: `raw/08_landing_page_copy.md`._
...
Icon: Search  
**Find your business**  
"Type your business name. We find you on Google Maps."

**Step 2**  
Icon: Wand  
**We build your site**  
"Our AI reads your Google listing and writes copy, picks colors, and designs a professional site. Takes about 90 seconds."

**Step 3**  
Icon: Globe  
**Go live instantly**  
"Your site is published to a real URL the moment it's done. Share it, put it on your card, add it to your Google listing."

---

## Features Section

**Section header**: `Everything a local business needs. Nothing it doesn't.`
...
**Section header**: `What local business owners say`

*(Placeholder — collect real testimonials before launch)*
...
**Subheader**: `Start free for 14 days — no credit card needed.`
...
A: You can still try Onara and compare. Many users replace old Wix/Squarespace sites after seeing the difference.

---

## Final CTA Section

**Headline**: `Ready in 90 seconds. Seriously.`

**Body**: `No designer. No monthly meetings. No "$2,000 website" invoice. Just your business, live on the web.`

**CTA Button**: `Build My Free Website →`

**Under button**: `No credit card · Cancel anytime · Setup in 90 seconds`

---

## Footer

**Links**: Home · Pricing · Privacy Policy · Terms of Service · support@onara.tech

**Tagline**: `© 2026 Onara · AI websites for local businesses`
...
| Location | Copy |
|----------|------|
| Search input placeholder | `Search for your business...` |
| Search button | `Find My Business` |
...
- `raw/08_landing_page_copy.md` — full source with additional variants
- `wiki/business/pricing.md` — pricing psychology and rationale
- `wiki/business/icp.md` — who the landing page is written for
