...
| [prompts.md](prompts.md) | All 10 agent system prompts + user prompt templates + Supervisor prompt |
| [blackboard.md](blackboard.md) | Blackboard Python dict schema, field lifetimes, parallel execution, memory management |
