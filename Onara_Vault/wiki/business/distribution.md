...
_Go-to-market channels, outbound scripts, and referral programs. Source: `raw/09_outbound_scripts.md`._
...
| Reddit | $0 | Low | As opportunity arises | 6 |
...
- Business has ≥ 10 Google reviews (active, established)
...
## Channel 3: Accountant Referral Program

**Structure**:
- Accountant refers a client → client signs up → accountant earns 20% MRR for 12 months
- Tracked via unique signup link
- Paid monthly via PayPal or bank transfer

**Pitch to accountants**:

```
Subject: Add a new service for your clients — zero work for you

Hi [Name],

Many of your SMB clients probably don't have a website, or have one that embarrasses them.

Onara builds a professional website from their Google listing in 90 seconds — $12/month.

If you refer clients, you earn 20% of their subscription for a year. No technical work on your end.

Would you be open to a 15-minute call to see how it works?
```

**Target**: Accountants serving 50+ SMB clients
...
## Channel 5: Cold Email

**Template**:

```
Subject: Found your Google listing — you're missing a website

Hi [Name],

I found [Business Name] on Google Maps. You have great reviews, but you don't have a website listed.

I built a tool that creates a professional website from your Google listing in 90 seconds.
...
**Personalization required**: Always include business name.
...
| Date | Channel | Target | Business | Status | Response |
|------|---------|--------|----------|--------|----------|
| YYYY-MM-DD | FB Group | Group Name | Business Name | Posted | — |
| YYYY-MM-DD | Cold DM | Instagram | Business Name | DM sent | No response |

**Status values**: Posted / DM sent / Emailed / Responded / Signed up / No response / Declined

---

## Related Files

- `wiki/business/icp.md` — who to target with each channel
- `wiki/content/outbound-scripts.md` — full script variants
- `raw/09_outbound_scripts.md` — complete source scripts
