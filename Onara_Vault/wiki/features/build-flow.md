...
rejected; the original Onara loading preview remains visible until a complete document with
visible content is available.
...
| `preview` | Replace the loading preview only with complete, visibly renderable HTML |
